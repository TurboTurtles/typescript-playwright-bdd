...
Feature: Search
  ...
  Scenario: Registration test
    ...
    # Then I select dropdown element using css "select[id='days']" by value "10"
    # Then I select dropdown element using css "select[id='months']" by value "5"
    # Then I select dropdown element using css "select[id='years']" by value "1995"
    ...
    Then I select dropdown element using css "select[id='country']" by value "Canada"
    ...
    Then I should see element using css "a[href='/logout']" inner text contains "Logout"
    Then I fill element using css "input[id='password']" with value "12345"
    Then I select dropdown element using css "select[id='days']" by value "10"
    Then I select dropdown element using css "select[id='months']" by value "5"
    Then I select dropdown element using css "select[id='years']" by value "1995"
